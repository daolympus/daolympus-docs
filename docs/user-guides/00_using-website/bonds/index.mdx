...
The former are called [liquidity bonds](../../contracts/glossary#liquidity-bonds) and the latter [reserve bonds](../../contracts/glossary#reserve-bonds).
...
Daolympus offers two types of bonds [on its website](https://app.olympusdao.finance/#/bonds), reserve and liquidity bonds.
You can follow the [tutorial](bond_example) to see a step-by-step guide to bonding.
...
- _An "Approve" transaction is needed when bonding an asset for the first time; this transaction gives the [Daolympus bond contract](../../contracts/bonds) the permission to execute the bond. Subsequent bonding only requires you to perform the "Bond" transaction._
