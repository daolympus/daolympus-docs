...
This tutorial will be given for an OHM-ETH bond, which is a [liquidity bond](../../contracts/glossary#liquidity-bonds).
...
2. Head to the [bonds page](https://app.olympusdao.finance/#/bonds) of the Daolympus website.
...
2. If this is your first purchase of this type of bond, you need to approve the Daolympus contract to spend your tokens. Click "Approve" and sign the transaction.
