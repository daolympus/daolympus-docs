...
Staking allows you to earn OHM passively via auto-compounding. By staking your OHM with DaolympusDAO, you receive sOHM (staked OHM) in return at a 1:1 ratio. After that, your sOHM balance will increase automatically on every epoch based on the current APY.

Check out this video on how to get OHM and stake it on Daolympus:

<YouTube youTubeId="aXAE1ikVMpM" alt="How to get OHM and stake it on Daolympus"/>
...
2\. Make sure the output currency is OHM. You can also copy and paste the [OHM contract address](../contracts/tokens#ohm) into the output currency field to ensure you are swapping for the right token.
...
6\. You should see OHM in your wallet balance now after the swap transaction is successful. If you cannot find it in your wallet, add [OHM contract address](../contracts/tokens#ohm) to your wallet.
...
1. Go to the [Stake page of the DaolympusDAO website](https://app.olympusdao.finance/#/). Select the "Stake" tab.
...
1. Go to the [Stake page of the DaolympusDAO website](https://app.olympusdao.finance/#/). Select the "Unstake" tab.
...
**TVL** measures the dollar amount of all the staked OHM in Daolympus.
